...
//       echo $this->Lang('invalid_address').': '.$address;
    ...
    public function GetMailMIME()
    {
        ...
        case 'alt_attachments':
            if ($this->InlineImageExists()) {
                $result .= sprintf(
                    "Content-Type: %s;%s\ttype=\"text/html\";%s\tboundary=\"%s\"%s", 'multipart/related', $this->LE,
                    $this->LE, $this->boundary[1], $this->LE
                );
            } else {
    ...
    public function CreateBody()
    {
        ...
        case 'alt_attachments':
            ...
            $body .= sprintf(
                "Content-Type: %s;%s" . "\tboundary=\"%s\"%s", 'multipart/alternative', $this->LE, $this->boundary[2],
                $this->LE . $this->LE
            );
